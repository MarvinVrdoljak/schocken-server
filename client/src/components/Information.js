    ...
    <div className={"modal" + (state.modalIsOpen ? ' modal--open' : '')}>
        <div className="modal__wrapper">
            ...
            <div className="modal__content">
                <h2>Informationen</h2>
                <p><strong>Willkommen bei Schocoronia - <a href="https://www.spielregeln.de/schocken.html" target="_blank" alt="Regeln">Schocken</a> für die Quarantäne Zeit!</strong></p>
